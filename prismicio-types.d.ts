...
/**
 * Bento variation for Bento Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
...
export interface PartnersSliceDefaultPrimary {
  ...
  /**
   * Body field in *Partners → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: partners.primary.body
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  body: prismic.RichTextField;
}
...
export interface PartnersSliceDefaultItem {
  /**
   * Icon field in *Partners → Items*
   *
   * - **Field Type**: Select
   * - **Placeholder**: *None*
   * - **API ID Path**: partners.items[].icon
